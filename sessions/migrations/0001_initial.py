    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enfant', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='enfant_session', to='enfants.HandicapEnfant')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professionnel_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='user', to=settings.AUTH_USER_MODEL)),
